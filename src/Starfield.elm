...
viewFerris time ferris =
    ...
    div
        [ style "position" "absolute"
        , style "left" ("calc(" ++ String.fromFloat (ferris.x + driftX) ++ "% - " ++ String.fromFloat (s / 2) ++ "px)")
        , style "top" ("calc(" ++ String.fromFloat (ferris.y + driftY) ++ "% - " ++ String.fromFloat (s / 2) ++ "px)")
        , style "width" (String.fromFloat s ++ "px")
        ...
        [ svg
            [ SA.viewBox "0 0 120 100"
            , SA.width (String.fromFloat s)
            , SA.height (String.fromFloat (s * 100 / 120))
            , SA.fill "none"
            ]
            [ -- Helmet visor (glass dome)
              Svg.ellipse
                [ SA.cx "60"
                , SA.cy "38"
                , SA.rx "28"
                , SA.ry "26"
                , SA.fill "rgba(168,85,247,0.15)"
                , SA.stroke "rgba(168,85,247,0.5)"
                , SA.strokeWidth "1.5"
                ]
                []
            , -- Helmet reflection arc
              Svg.path
                [ SA.d "M42 28 Q52 18 68 22"
                , SA.stroke "rgba(200,180,255,0.4)"
                , SA.strokeWidth "1"
                , SA.fill "none"
                ]
                []
            ...
            , Svg.ellipse
                ...
                , SA.rx "32"
                , SA.ry "20"
                , SA.fill "rgba(220,80,50,0.85)"
                , SA.stroke "rgba(220,80,50,0.5)"
                , SA.strokeWidth "1"
                ]
                []

            -- Ferris shell segments
            , Svg.path
                [ SA.d "M44 50 Q52 42 60 50 Q68 42 76 50"
                , SA.stroke "rgba(180,60,40,0.6)"
                , SA.strokeWidth "0.8"
                , SA.fill "none"
                ]
                []
            ...
            -- Left claw
            , Svg.path
                [ SA.d "M28 58 L18 50 L14 56 L22 60 Z"
                , SA.fill "rgba(220,80,50,0.75)"
                , SA.stroke "rgba(220,80,50,0.5)"
                , SA.strokeWidth "0.8"
                ]
                []
            ...
            -- Right claw
            , Svg.path
                [ SA.d "M92 58 L102 50 L106 56 L98 60 Z"
                , SA.fill "rgba(220,80,50,0.75)"
                , SA.stroke "rgba(220,80,50,0.5)"
                , SA.strokeWidth "0.8"
                ]
            ...
            -- Legs (3 pairs)
            , Svg.path
                [ SA.d "M38 70 L28 82 M44 72 L36 86 M50 73 L44 88"
                , SA.stroke "rgba(220,80,50,0.6)"
                , SA.strokeWidth "1.2"
                , SA.strokeLinecap "round"
                ]
                []
            , Svg.path
                [ SA.d "M82 70 L92 82 M76 72 L84 86 M70 73 L76 88"
                , SA.stroke "rgba(220,80,50,0.6)"
                , SA.strokeWidth "1.2"
                , SA.strokeLinecap "round"
                ]
